...
$(document).ready(function(){
    ...
    $(addButton).click(function(){
        ...
        if(x < maxField){
            ...
            $(wrapper).append('<div><input type="text" name="field_name['+i+']" value=""/><a href="javascript:void(0);" class="remove_button"><i class="fas fa-trash-alt"></i></a></div>'); //Add field html
        }
    });
