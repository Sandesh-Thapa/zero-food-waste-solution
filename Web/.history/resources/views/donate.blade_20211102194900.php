...
$(document).ready(function(){
    ...
    $(addButton).click(function(){
        ...
        if(x < maxField){
            ...
            $(wrapper).append('
            <div><select type="text" name="field_name['+i+'][name]" class="form-control form-control-alternative"><option value="1">One</option></select><input type="text" name="field_name['+i+'][qty]" value=""/><a href="javascript:void(0);" class="remove_button"><i class="fas fa-trash-alt"></i></a></div>');
        }
    });
