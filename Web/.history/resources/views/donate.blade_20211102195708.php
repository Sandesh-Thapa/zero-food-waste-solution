                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-6 p-2">
                                    <select name="field_name[0]['name']" id="input-document_type" class="form-control form-control-alternative{{ $errors->has('item_id') ? ' is-invalid' : '' }}" required>
                                ...
                                <div class="col-sm-6 p-2">
                                    <input type="text" class="form-control" name="field_name[0][qty]" value=""/>
                                </div>
                                <div class="col-sm-6 p-2">
                                    <select name="field_name[1]['name']" id="input-document_type" class="form-control form-control-alternative{{ $errors->has('item_id') ? ' is-invalid' : '' }}" required>
                                        @foreach ($orderItems as $item)
                                            <option value="{{$item->id}}">{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6 p-2">
                                    <input type="text" class="form-control" name="field_name[1][qty]" value=""/>
                                </div>
                                <div class="col-sm-6 p-2">
                                    <select name="field_name[2]['name']" id="input-document_type" class="form-control form-control-alternative{{ $errors->has('item_id') ? ' is-invalid' : '' }}" required>
                                        @foreach ($orderItems as $item)
                                            <option value="{{$item->id}}">{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6 p-2">
                                    <input type="text"  class="form-control" name="field_name[2][qty]" value=""/>
                                </div>
                            </div>
                        </div>
                    </div>
