...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $latest_donors = OrderDonation::with(['orderDonationItem', 'orderDonationItem.orderItem'])->orderBy('order_date','DESC')->get();
dd($latest_donors);
        $order_items = [];
        ...
        return view('dashboard', compact(['total_requests', 'total_donations', 'total_donors','next_request', 'next_donation', 'latest_donors']));
    }
