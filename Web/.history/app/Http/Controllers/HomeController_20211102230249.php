...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return $order_items->json_encode();
        $client = new Client();
        $res = $client->request('POST', '192.168.1.3:5000/requests/forecast/', [
                'today_data' => $order_items[0],
                'yesterday_data' => $order_items[1],
                'past_2_days_data' => $order_items[2],
                'past_3_days_data' => $order_items[3]
        ]);
        dd($res);
