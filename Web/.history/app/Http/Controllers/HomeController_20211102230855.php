...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = [
                ...
                'yesterday_data' => ['Buttermilk', 'Rotisserie chicken', 'Lettuce, leaf', 'Chicken nuggets, patties', 'Fruit, cut', 'Salsa, picante & taco sauces', 'Pies, mincemeat', 'Brussels sprouts', 'Soy or rice beverage, soy beverage powders', 'Cream, half-and-half', 'Beans, Dried', 'Baby food, formula', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, non['Buttermilk', 'Rotisserie chicken', 'Lettuce, leaf', 'Chicken nuggets, patties', 'Fruit, cut', 'Salsa, picante & taco sauces', 'Pies, mincemeat', 'Brussels sprouts', 'Soy or rice beverage, soy beverage powders', 'Cream, half-and-half', 'Beans, Dried', 'Baby food, formula', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping'],
        ...
        $res = $client->request('POST', '192.168.1.3:5000/requests/forecast/', ['form_params' => $data]);
        dd($res);
