...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $donation_res = $client->request('POST', 'http://192.168.1.3:5000/requests/forecast/',['form_params'=>$data]);

        $next_donation= $donation_res->getBody()->getContents();
        $next_donation = json_decode($next_donation)->data;

        return view('dashboard', compact(['total_requests', 'total_donations', 'total_donors','next_request', 'next_donation']));
    }
