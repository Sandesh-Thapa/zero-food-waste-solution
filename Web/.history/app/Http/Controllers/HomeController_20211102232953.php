...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $client = new Client();
        $data = [
                "today_data" => json_encode(['Buttermilk', 'Rotisserie chicken', 'Lettuce, leaf', 'Chicken nuggets, patties', 'Fruit, cut', 'Salsa, picante & taco sauces', 'Pies, mincemeat', 'Brussels sprouts', 'Soy or rice beverage, soy beverage powders', 'Cream, half-and-half', 'Beans, Dried', 'Baby food, formula', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping']),
                "yesterday_data" => json_encode(['Buttermilk', 'Rotisserie chicken', 'Lettuce, leaf', 'Chicken nuggets, patties', 'Fruit, cut', 'Salsa, picante & taco sauces', 'Pies, mincemeat', 'Brussels sprouts', 'Soy or rice beverage, soy beverage powders', 'Cream, half-and-half', 'Beans, Dried', 'Baby food, formula', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping']),
                "past_2_days_data" => json_encode(['Buttermilk', 'Rotisserie chicken', 'Lettuce, leaf', 'Chicken nuggets, patties', 'Fruit, cut', 'Salsa, picante & taco sauces', 'Pies, mincemeat', 'Brussels sprouts', 'Soy or rice beverage, soy beverage powders', 'Cream, half-and-half', 'Beans, Dried', 'Baby food, formula', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping']),
                "past_3_days_data" => json_encode(['Buttermilk', 'Rotisserie chicken', 'Lettuce, leaf', 'Chicken nuggets, patties', 'Fruit, cut', 'Salsa, picante & taco sauces', 'Pies, mincemeat', 'Brussels sprouts', 'Soy or rice beverage, soy beverage powders', 'Cream, half-and-half', 'Beans, Dried', 'Baby food, formula', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping', 'Aerosol can, nondairy topping'])
        ];
        ...
        dd(json_decode($next_request)->data);
