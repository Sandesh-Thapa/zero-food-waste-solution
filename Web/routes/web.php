...
use App\Http\Controllers\OrderDonationController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('donate/', 'OrderDonationController@index')->name('donate');
    Route::post('donate/store', 'OrderDonationController@store')->name('donate.store');
